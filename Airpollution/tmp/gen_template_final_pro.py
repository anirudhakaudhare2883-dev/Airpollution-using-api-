...
<body>
    ...
    <script>
        ...
        async function sendMessage() {
            ...
            try {
                // FIXED: Changed gemini-1.5-flash to gemini-pro which is universally supported on all accounts.
                ...
                if(data.candidates && data.candidates[0].content && data.candidates[0].content.parts) {
                    ...
                    appendMessage(`<span style='color:red'>API Error: ${data.error.message}</span>`, 'bot');
        ...
        function appendMessage(html, sender, id="") {
            ...
            // timeout needed sometimes so dom updates before scroll
            setTimeout(() => {
...
print("Template written successfully with gemini-pro fallback!")
