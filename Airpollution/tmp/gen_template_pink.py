...
<head>
    ...
    <title>AirQuality AI | Pink Premium</title>
    ...
    <style>
        :root {
            /* Premium Pink / Light Pink Theme */
            --bg-base: #1b1216; /* Deep dark pinkish hue */
            --bg-nav: rgba(27, 18, 22, 0.85);
            --bg-card: rgba(38, 23, 30, 0.6);
            --border: rgba(255, 255, 255, 0.05);
            --border-highlight: rgba(236, 72, 153, 0.4);
            --accent: #ec4899; /* Hot Pink */
            --accent-sec: #f472b6; /* Light Pink */
            --t-main: #fcf8f9;
            --t-mut: #fbcfe8; /* Muted Light Pink */
            
            --success: #10b981;
            --warning: #f59e0b;
            --danger: #e11d48;
            --shadow: 0 10px 30px -5px rgba(0, 0, 0, 0.4), 0 8px 10px -6px rgba(236, 72, 153, 0.1);
        ...
        body {
            ...
            overflow-x: hidden;
            background-image: 
                radial-gradient(circle at 10% 50%, rgba(236, 72, 153, 0.05), transparent 40%),
                radial-gradient(circle at 90% 30%, rgba(244, 114, 182, 0.08), transparent 40%);
        }

        ::-webkit-scrollbar { width: 6px; }
        ::-webkit-scrollbar-track { background: var(--bg-base); }
        ::-webkit-scrollbar-thumb { background: #831843; border-radius: 4px; }
        ...
        /* CARDS */
        .glass-card {
            background: linear-gradient(160deg, rgba(38, 23, 30, 0.6), rgba(27, 18, 22, 0.8));
            backdrop-filter: var(--glass-blur);
            -webkit-backdrop-filter: var(--glass-blur);
        ...
        .glass-card:hover {
            ...
            box-shadow: 0 15px 35px rgba(0,0,0,0.5), 0 0 20px rgba(236, 72, 153, 0.15);
        }
        ...
        .form-control-neo::placeholder { color: #831843; } /* Very dark pink placeholder */
        ...
        .dash-title strong { font-weight: 800; color: var(--accent-sec); }
        ...
        .kpi-card {
            background: linear-gradient(145deg, rgba(80, 24, 46, 0.4) 0%, rgba(38, 23, 30, 0.6) 100%);
            border: 1px solid rgba(236, 72, 153, 0.2);
            border-radius: var(--radius);
            padding: 1.5rem;
            display: flex;
        ...
        #map {
            ...
            z-index: 1;
            /* Pink hue shift */
            filter: invert(90%) hue-rotate(280deg) brightness(95%) contrast(100%) grayscale(20%) sepia(40%) hue-rotate(-20deg);
        }
        ...
        /* AI INSIGHTS */
        .ai-panel {
            background: linear-gradient(to right, rgba(80, 24, 46, 0.6), rgba(38, 23, 30, 0.5));
            border: 1px solid rgba(236, 72, 153, 0.3);
            padding: 2.5rem;
            border-radius: var(--radius);
            position: relative;
        ...
        /* CHATBOT STYLES (Light Pink Premium theme) */
        #chatbot-fab {
            position: fixed;
            bottom: 2rem;
            right: 2rem;
        ...
        .chat-header {
            background: linear-gradient(135deg, rgba(236, 72, 153, 0.2), rgba(244, 114, 182, 0.3));
        ...
        .chat-header i.fa-robot { color: var(--accent-sec); font-size: 1.2rem; }
        .chat-header button {
        ...
        .chat-input-area button:hover { transform: scale(1.05); box-shadow: 0 0 15px rgba(236, 72, 153, 0.5); }
...
<body>
    ...
    <nav class="pn">
        <div class="inner">
            <a class="nb" href="#">
                <div class="nb-i"><i class="fa-solid fa-cloud-moon"></i></div>
                <div>
    ...
    <div class="dw">
        <div class="row g-4">
            ...
            <div class="col-xl-9">
                ...
                <div class="main-grid">
                    <!-- LEFT: MAP (OSM WITH PINK-TINT CSS INVERT) -->
                    ...
                    <div class="col-lg-7">
                        <div class="ai-panel h-100">
                            ...
                            <div class="ai-text mt-3">
                                ...
                                <br><br>
                                The dominant atmospheric element driving this alert is <strong id="ai-prime" style="color:var(--accent-sec)">--</strong>.<br>
                                <br>
    ...
    <script>
        ...
        // Deep Pink/Light Pink palette mapping
        const hexMap = {
            ...
            'maroon': '#be185d' // Pink Dark
        };
        const actualColor = hexMap[COLOR] || '#ec4899'; // Fallback to hot pink

        // Apply dynamic colors
        document.getElementById('aqi-bar').style.background = `linear-gradient(90deg, #1b1216, ${actualColor}, ${actualColor})`;
        ...
        const ttOpts = { 
            backgroundColor: 'rgba(38, 23, 30, 0.95)', 
            titleColor: '#fff', 
            bodyColor: '#fbcfe8', 
        ...
        (function(){
            ...
            const colors = ['#ec4899', '#f472b6', '#fbcfe8', '#db2777'];  // Pink tones
            new Chart(ctx, {
                type: 'doughnut',
                data: {
                ...
                options: {
                    maintainAspectRatio: false,
                    plugins: {
                        legend: { position: 'right', labels: { usePointStyle: true, boxWidth: 8, color: '#fcf8f9', font: {size:11, family:'Outfit'} } },
                        tooltip: ttOpts
                    },
                    cutout: '78%',
        ...
        (function(){
            ...
            new Chart(ctx, {
                ...
                data: {
                    labels: Object.keys(poll),
                    datasets: [
                        { label: 'Live Telemetry', data: dataVals, backgroundColor: '#ec4899', borderRadius: 6, barPercentage: 0.5 },
                        { label: 'WHO Limit', data: who, backgroundColor: 'rgba(255,255,255,0.1)', borderRadius: 6, barPercentage: 0.5 }
                    ]
                },
                options: {
                    maintainAspectRatio: false,
                    ...
                    plugins: { tooltip: ttOpts, legend: { position: 'top', align: 'end', labels: {usePointStyle: true, boxWidth:8, color: '#fbcfe8'} } },
                    animation: { duration: 1500, delay: 300 }
                }
            });
        })();

        // MAP - RESTORED OSM WITH PINK TINT CSS INVERT FILTER (set in CSS #map)
        setTimeout(() => {
            const m = L.map('map', { zoomControl: true }).setView([LAT, LON], 11);
            L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', { 
                attribution: '&copy; <a href="https://www.openstreetmap.org/copyright" style="color:#f472b6">OSM</a>', 
                maxZoom: 19 
            }).addTo(m);
            ...
            const pop = L.popup({className: 'dark-popup'}).setContent(`<div style="color:#1b1216;font-weight:700;font-family:'Outfit'">AQI: ${AQI}<br><span style="color:${actualColor}">${CAT}</span></div>`);
...
print("Template written successfully with Premium Pink Theme!")
